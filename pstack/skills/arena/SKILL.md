...
3. Pick the runners. Default runners are your configured arena list (defaults `gpt-5.5-high-fast`, `composer-2.5`, `grok-4.5-xhigh` — exclude the judgment family so the cross-judge seat stays independent). Spawn more when the arena covers multiple design directions. Same model N times when the work is generation-bound rather than judgment-sensitive.
