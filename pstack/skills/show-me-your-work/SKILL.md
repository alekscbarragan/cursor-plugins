...
description: "Decision-trail TSV for long/unattended work — one row per decision (what, why, evidence, result). Use for /show-me-your-work or multi-phase autonomous runs."
